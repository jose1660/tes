pipeline {
  ...
  stages {
    stage('Inicio') {
      steps {
         script {
          withEnv(['HUBOT_URL=http://ip172-18-0-23-bd3qqsts2ti0008pm780-9999.direct.labs.play-with-docker.com','HUBOT_DEFAULT_ROOM=pull-requests','HUBOT_FAIL_ON_ERROR=false']) {
